 ...
 * Collects market conditions, entry signals, and outcomes.
 */
public class TradeFeatures {
    ...
    public TradeFeatures(
            double adx, double diPlus, double diMinus, double atr, double atrRatio,
            double rsi, double emaFast, double emaSlow, double emaRatio, double pricePosition,
            double volumeRatio, double volumeTrend,
            double entryConfidence, double riskRewardRatio, double stopDistance, String breakoutType,
            double signalStrength, double signalTypeTrend, double signalTypeFx, double signalTypeMixed,
            double groupConfirmed, double strongTrend, double rangeRegime,
            int hourOfDay, int dayOfWeek,
            String ticker, String strategy, LocalDateTime entryTime, double entryPrice) {
    ...
    public String toString() {
        return String.format("TradeFeatures{ticker=%s, strategy=%s, adx=%.1f, rsi=%.1f, outcome=%.2fR}",
