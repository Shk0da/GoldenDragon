...
/**
 * Stop loss manager with multiple stop types and trailing logic.
 * Supports fixed, ATR-based, and trailing stops.
 */
public class StopLossManager {
     ...
     * Only moves stop in favorable direction (up for long, down for short).
     *
     ...
     * For long: higher is better. For short: lower is better.
     *
