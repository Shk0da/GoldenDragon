...
/**
 * Adaptive capital manager implementing anti-martingale position sizing. Reduces risk after losses,
 * restores after wins. Never uses martingale (no doubling down on losses).
 */
public class AdaptiveCapital {
  ...
  public AdaptiveCapital(
      double baseRiskPercent, int lossesToReduce, int winsToRestore, double riskReductionFactor) {
  ...
  /** Register winning trade. Restores risk after consecutive wins. */
  ...
  /** Register losing trade. Reduces risk after consecutive losses. */
