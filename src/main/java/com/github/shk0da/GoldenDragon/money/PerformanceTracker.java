...
public class PerformanceTracker {
  ...
  public void registerTrade(
    ...
    SessionStats newStats =
        new SessionStats(newWins, newLosses, newTotalPnL, newTrades, newLargestWin, newLargestLoss);
  ...
  public static class SessionStats {
    ...
    SessionStats(
        int wins, int losses, double totalPnL, int trades, double largestWin, double largestLoss) {
      this.wins = wins;
      this.losses = losses;
