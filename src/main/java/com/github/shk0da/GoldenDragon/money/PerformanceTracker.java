...
/**
 * Performance tracker for trade statistics and PnL tracking.
...
public class PerformanceTracker {
     ...
     */
    public void registerTrade(double pnl, String ticker, String direction,
    ...
    public static class SessionStats {
        ...
        SessionStats(int wins, int losses, double totalPnL, int trades,
                     double largestWin, double largestLoss) {
            this.wins = wins;
            this.losses = losses;
