...
public class LoggingUtils {
  ...
  /**
   * Logs an error message with timestamp. Format: [dd.MM.yyyy HH:mm:ss] ERROR: message
   *
  ...
  /**
   * Logs a message with timestamp and custom format. Format: [dd.MM.yyyy HH:mm:ss.SSS] message
   *
   * @param message message to log
   */
  public static void logDetailed(String message) {
    ThreadLocal<SimpleDateFormat> detailedFormat =
