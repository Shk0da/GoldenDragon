...
/**
 * Market-specific configuration (MOEX, etc.). Provides currency and position cost limits for
 * different markets.
 */
    ...
    try {
      ...
      defaultMarketConfigs.put(
          ...
          new MarketConfig(
              Market.MOEX,
              Integer.parseInt(
                  properties.getProperty("market.moex.maxPositionCostToBuy", "100000")),
