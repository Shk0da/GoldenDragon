...
public class UnifiedTraderConfig {
  ...
  public static class TickerParams {
    ...
    public TickerParams(
        String group, double slMult, double tpMult, double riskP, boolean useMinuteCandles) {
      this(
          group,
          slMult,
          tpMult,
  ...
  public UnifiedTraderConfig() throws IOException {
    ...
    stocks =
        stream(
            ...
            .collect(toList());
    averagePositionCost =
        Double.valueOf(properties.getProperty("unifiedTrader.averagePositionCost", "10000"));
  ...
  private TickerParams loadSingleTickerParams(Properties properties, String ticker) {
    ...
    double volumeRatioMin =
        Double.parseDouble(properties.getProperty(prefix + "marketRegimeVolumeRatioMin", "30.0"));
    double confidenceMin =
        Double.parseDouble(properties.getProperty(prefix + "marketRegimeConfidenceMin", "50.0"));
    int atrBars = Integer.parseInt(properties.getProperty(prefix + "marketRegimeAtrBars", "4"));

    double lowVolumeThreshold =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherLowVolumeThreshold", "0.5"));
    double lowAtrThreshold =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherLowAtrThreshold", "0.7"));
    double minRangePercent =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherMinRangePercent", "0.005"));
    double highAtrThreshold =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherHighAtrThreshold", "2.0"));
    double maxSpreadPercent =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherMaxSpreadPercent", "0.01"));
    double maxWickRatio =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherMaxWickRatio", "0.4"));
    ...
    double atrSpikeThreshold =
        Double.parseDouble(properties.getProperty(prefix + "badWeatherAtrSpikeThreshold", "2.5"));
    ...
    double tickerMmRiskPercent =
        Double.parseDouble(properties.getProperty(prefix + "mmRiskPercent", String.valueOf(riskP)));
